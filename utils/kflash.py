...
class KFlash:
    ...
    def process(self, terminal=True, dev="", baudrate=1200000, board=None, sram = False, file="", callback=None, noansi=False, terminal_auto_size=False, terminal_size=(50, 1), slow_mode = False):
        self.killProcess = False
